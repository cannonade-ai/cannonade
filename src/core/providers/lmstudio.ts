...
export const lmStudioProvider: LLMProvider = {
  ...
  async deleteModelByHfId(hfModelId: string): Promise<void> {
    ...
    await Promise.all(matching.map((m) => lmStudioProvider.deleteModel!(m.key)))
  },
